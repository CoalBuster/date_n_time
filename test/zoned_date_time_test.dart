...
void main() {
  test('parse valid utc date', () {
    final date = ZonedDateTime.parse('2010-02-27T10:30:15Z');
    ...
    expect(date.zone, ZoneId.utc);
    expect(date.toString(), '2010-02-27T10:30:15.000Z');
  });

  test('parse valid system-zone date', () {
    final date = ZonedDateTime.parse('2010-02-27T10:30:15');
    expect(date.year, 2010);
    expect(date.month, 2);
    expect(date.day, 27);
    expect(date.dayOfWeek, DayOfWeek.saturday);
    ...
    expect(date.millisecond, 0);
    expect(date.microsecond, 0);
    expect(date.zone, ZoneId.system);
    expect(date.toString(), '2010-02-27T10:30:15.000');
  });

  test('parse leap year', () {
    final date = ZonedDateTime.parse('2012-02-29T10:30:15');
  ...
  test('parse rolls date', () {
    final date = ZonedDateTime.parse('2012-02-30T10:30:15');
    expect(date.year, 2012);
    expect(date.month, 3);
    expect(date.day, 1);
  ...
  test('plus Period adds ignores dst', () {
    final start = ZonedDateTime.parse('2024-10-26T10:30:15.000Z');
    final expected = ZonedDateTime.parse('2024-11-01T10:30:15.000Z');
  ...
  test('minus Period substracts ignores dst', () {
    final start = ZonedDateTime.parse('2024-10-01T10:30:15.000Z');
    final expected = ZonedDateTime.parse('2023-08-31T10:30:15.000Z');
  ...
  test('plus TimeSpan adds ignores dst', () {
    final start = ZonedDateTime.parse('2024-10-26T10:30:15.000Z');
    final expected = ZonedDateTime.parse('2024-10-28T10:30:15.000Z');
